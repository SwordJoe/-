...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_student_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Student, chinese_),
  PROTOBUF_FIELD_OFFSET(::Student, math_),
  PROTOBUF_FIELD_OFFSET(::Student, english_),
};
...
const char descriptor_table_protodef_student_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\004name\030\002 \001(\t\022\017\n\007chinese\030\003 \001(\005\022\014\n\004math\030\004 "
  "\001(\005\022\017\n\007english\030\005 \001(\005b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_student_2eproto = {
  false, false, 108, descriptor_table_protodef_student_2eproto, "student.proto", 
...
Student::Student(const Student& from)
  ...
  ::memcpy(&id_, &from.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&english_) -
    reinterpret_cast<char*>(&id_)) + sizeof(english_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&english_) -
    reinterpret_cast<char*>(&id_)) + sizeof(english_));
}
...
// @@protoc_insertion_point(message_clear_start:Student)
  ...
  ::memset(&id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&english_) -
      reinterpret_cast<char*>(&id_)) + sizeof(english_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          chinese_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 math = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          math_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 english = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          english_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Student::_InternalSerialize(
  ...
  if (this->chinese() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_chinese(), target);
  }

  // int32 math = 4;
  if (this->math() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_math(), target);
  }

  // int32 english = 5;
  if (this->english() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_english(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Student)
  ...
  if (from.chinese() != 0) {
    _internal_set_chinese(from._internal_chinese());
  }
  if (from.math() != 0) {
